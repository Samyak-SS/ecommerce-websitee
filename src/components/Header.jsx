...
const Header = ({colorDeep}) => {
  const [openMenu, setOpenMenu] = useState(false);
    ...
    return (
    <header className="flex lg:items-center lg:justify-between lg:flex-row lg:gap-0 w-fu;; md:px-16  max-w-[100vw] flex-col gap-4 px-4">
      <div className="flex flex-row items-center justify-between  w-full  lg:w-auto">
        <div className={`flex justify-center items-center  border-2 h-18 w-18 rounded-lg p-1`} style={{borderColor:`${colorDeep}`}}>
          <img src={promoil} alt="promoil logo" className="w-full h-auto max-w-[60px]" width="50" height="80"/>  
        </div>
